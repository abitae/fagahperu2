        ...
        <div class="w-full mb-1">
            ...
            <div class="sm:flex">
                <div
                    ...
                    <label for="categorys-search" class="sr-only">Search</label>
                ...
                <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                    ...
                    @if ($isOpenModal)
                        <x-modal title="{{ isset($categoryForm->category) ? 'Update Category' : 'Create Category' }}"
                            maxWidth='sm'>
                            <form class="form"
                                ...
                                <div class="p-4 md:p-5 space-y-4">
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6 sm:col-span-6">
                                            <x-text-input wire:model.live='categoryForm.code' type='text'
                                                for='code' label='Codigo' placeholder='Ingrese codigo' />
                                        ...
                                        <div class="col-span-6 sm:col-span-6">
                                            <x-text-input wire:model.live='categoryForm.name' type='text'
                                                for='name' label='Nombre' placeholder='Ingrese nombre' />
                            ...
                            <tr wire:key='category-{{ $category->id }}'
                                ...
                                <td class="p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white">
                                    <button wire:click='estado({{ $category->id }})'
                                        ...
                                        <div
                                            class="h-2.5 w-2.5 rounded-full {{ $category->isActive ? 'bg-green-400' : 'bg-red-600' }} mr-2">
                                        </div>
                                        {{ $category->isActive ? 'Active' : 'Disabled' }}
                                    </button>
                                </td>
                                <td class="p-4 space-x-2 whitespace-nowrap">
                                    <x-button.button-edit wire:click='update({{ $category->id }})'>
                                    </x-button.button-edit>
                                    <x-button.button-delete wire:click='delete({{ $category->id }})'
