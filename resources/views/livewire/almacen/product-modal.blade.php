            ...
            <div x-data="{ openTab: 1 }">
                <div class="w-full bg-white dark:bg-gray-800">
                    ...
                    <div x-show="openTab === 1"
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-2">
                                <x-text-input wire:model.live='productForm.code' type='text' for='code'
                                    label='Codigo Unico' placeholder='Ingrese codigo' required />
                            ...
                            <div class="col-span-6 sm:col-span-2">
                                <x-text-input wire:model.live='productForm.code_fabrica' type='text'
                                    for='code_fabrica' label='Codigo fabrica' placeholder='Ingrese codigo fabrica'
                                    required />
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-2">
                                <x-text-input wire:model.live='productForm.price_compra' type='number' min="0"
                                    step=".01" for='price_compra' label='Precio de Compra'
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                <x-area-input wire:model.live='productForm.description' type='text'
                                    for='description' label='Description' placeholder='Ingrese description'
                                    required />
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <x-area-input wire:model.live='productForm.observaciones' type='text'
                                    for='observaciones' label='Observaciones' placeholder='Ingrese observaciones' />
